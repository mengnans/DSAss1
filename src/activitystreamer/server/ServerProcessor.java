        ...
        if(argJsonObject.has("command")){
            ...
            switch (argJsonObject.get("command").toString()){
                ...
                case "SERVER_ANNOUNCE":
                    ...
                    else if(!argJsonObject.has("id")||!argJsonObject.has("load")||
                            !argJsonObject.has("hostname")||!argJsonObject.has("port")){
                        INVALID_MESSAGE.addProperty("command","INVALID_MESSAGE");
                ...
                case "LOCK_DENIED":
                    ...
                    //remove username from local storage
                        ...
                        for(JsonObject registerClient: ServerItem.getClientResigterInfo()){
                            if(registerClient.get("username").toString().equals(argJsonObject.get("username").toString())&&
                                    registerClient.get("secret").toString().equals(argJsonObject.get("secret").toString())){
                ...
                case "ACTIVITY_MESSAGE":
                    ...
                    else if(argJsonObject.get("username").toString().equals("anonymous") &&
                            !(argJsonObject.get("username").toString().equals(localStorage.get("username").toString()) &&
                                    argJsonObject.get("secret").toString().equals(localStorage.get("secret").toString()))){
                        AUTHENTICATION_FAIL.addProperty("command","AUTHENTICATION_FAIL");
                        AUTHENTICATION_FAIL.addProperty("info","you did not login");
                        apiHelper.SendMessage(argConnection,AUTHENTICATION_FAIL);
                        return true;
